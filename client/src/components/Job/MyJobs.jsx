...
const MyJobs = () => {
    ...
    const fetchJobs = async () => {
      try {
        const { data } = await axios.get(
          `${process.env.REACT_APP_BACKEND_URL}job/getmyjobs`,
  ...
  const handleUpdateJob = async (jobId) => {
    ...
    await axios
      .put(`${process.env.REACT_APP_BACKEND_URL}/job/update/${jobId}`, updatedJob, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  const handleDeleteJob = async (jobId) => {
    await axios
      .delete(`${process.env.REACT_APP_BACKEND_URL}/job/delete/${jobId}`, {
        withCredentials: true,
      })
      .then((res) => {
        toast.success(res.data.message);
